...
# hyperfleet.io/hyperfleet-operator-bundle:$VERSION and hyperfleet.io/hyperfleet-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= hyperfleet.io/hyperfleet-operator
